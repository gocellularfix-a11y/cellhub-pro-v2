// ============================================================
// Companion Lite — Background polling runtime.
//
// Mounted globally by AppShell via CompanionLiteRuntimeMount, this
...
// so leaving Companion Lite silenced all notifications.
//
// Notification routing:
//   - Always: fire global toast (visible from any tab).
//   - When activeTab !== 'companionLite': also push to the badge +
//     ephemeral bubble hint (out-of-context surfaces).
//   - When activeTab === 'companionLite': skip badge/bubble — the
...
export function startCompanionLiteRuntime(b: RuntimeBindings): void {
  bindings = b;
...
export function stopCompanionLiteRuntime(): void {
