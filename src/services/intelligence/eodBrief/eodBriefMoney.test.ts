...
// (adjustSalesItemCosts + computeCustomerProfit) actually runs — not a stub.
// All money values are integer cents and >= 1000 so the schema adapter's
// dollar/cents heuristic leaves them untouched.
//
...
describe('getTodayMoney — today filter + refund math', () => {
  it('excludes yesterday, includes today, subtracts returns, adjusts profit', () => {
    ...
    // raw profit (10000−6000)=4000; refund adj = round(2000 × 0.4)=800 → 3200.
