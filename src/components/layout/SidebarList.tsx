...
// dashboard themes ('list' | 'tiles' | 'bold-blocks'). Functionally
// identical to the tile-grid Sidebar — same nav items, same handlers,
// same data — only the visual chrome differs.
