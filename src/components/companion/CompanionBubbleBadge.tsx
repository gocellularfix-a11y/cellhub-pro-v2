// ============================================================
// Companion — Persistent badge anchored to the floating
// operator bubble. Shows the unattended count of Companion
// events (messages, approval responses, approval-thread messages).
//
// Click on the badge:
//   1. captures the most-recent source ('messages' | 'approvals')
//   2. switches the sidebar to the 'companion' tab
//   3. stages a routeHint so CompanionPage opens the right
...
const KEYFRAMES_STYLE_ID = 'companion-badge-keyframes';
...
export default function CompanionBubbleBadge() {
  ...
  const handleClick = () => {
    const source = navigateToCompanion();
    setActiveTab('companion');
    void source; // CompanionPage will read it via consumeRouteHint.
  };
