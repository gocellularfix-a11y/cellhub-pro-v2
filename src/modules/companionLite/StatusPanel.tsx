// Companion Lite — Status panel (desktop).
...
import { pushStoreStatus } from '@/services/companionLite/storeStatusService';
import { computeLiteSnapshot } from '@/services/companionLite/snapshot';
