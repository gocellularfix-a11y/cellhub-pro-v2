...
import type { CompanionNotificationPriority, CompanionNotificationType } from '@/services/companion/companionTypes';
...
// R-COMPANION-NOTIFICATION-INFRA-V1: notification priority chip palette
...
export default function CompanionCenter() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', maxWidth: '1100px' }}>
      ...
      {/* R-COMPANION-NOTIFICATION-INFRA-V1: notification center */}
      <div style={{
        marginTop: '0.75rem',
