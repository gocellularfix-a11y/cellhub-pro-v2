// Companion — Messages panel (desktop).
...
import {
  listMessages,
  sendMessage,
} from '@/services/companion/messagesService';
// Notification routing (toast + bubble + badge) is owned by the global
// CompanionRuntime mounted in AppShell. This panel only renders.
