...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  ${taxRows80}
  ${feeRows80}
  ${r80('TOTAL:', fmt(sale.total), { row: 'border-top:1px solid #000;padding-top:3px;margin-top:2px', lab: 'font-size:13px;font-weight:800', amt: 'font-size:15px;font-weight:900;padding-right:4px' })}
...
<style>
  ...
  <table style="margin-bottom:5px">
    ...
    ${(sale.creditCardFee || 0) > 0 ? `<tr><td>${es ? 'Cargo de Tarjeta:' : pt ? 'Taxa de Cartão:' : 'Card Fee:'}</td><td style="text-align:right">${fmt(sale.creditCardFee!)}</td></tr>` : ''}
